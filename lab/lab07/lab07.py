def insert_into_all(item, nested_list):
    ...
    [[0], [0, 1, 2], [0, 3]]
    """
    return   sum([[[item] + nest] for nest in nested_list],[])
...
def inc_subseqs(s):
    ...
    #         return [[]]+[[prev]]
    #     elif s[0] < prev:
    #         return subseq_helper(s[1:],s[0]) + subseq_helper(s[1:],prev)
    #     else:
    #         a = prev
...
def make_glookup(class_assignments):
    ...
    """
    "*** YOUR CODE HERE ***"
    total_credit,full = 0,0
    def add(type,credit):
        nonlocal total_credit,full
        total_credit+=credit
        full +=cs61a[type]
        return total_credit/full
    return add
...
def make_advanced_counter_maker():
    ...
    def make_counter():
        personal_cnt = 0
        def personal(str):
            nonlocal global_cnt,personal_cnt
            "*** YOUR CODE HERE ***"
